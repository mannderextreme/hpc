...
TEST_CASE("Resulting matrix c from reference kernel has correct values"){
    int c[3][3]  = {0}
...
TEST_CASE("Resulting matrix c from 32mnk kernel has correct values"){
    int c[3][3]  = {0}
...
TEST_CASE("Resulting matrix c from 32nkm kernel has correct values"){
    int c[3][3]  = {0}
...
TEST_CASE("Resulting matrix c from 32nkm kernel has correct values for fp aswell"){
    float c[3][3]  = {0}
    gemm_32_32_32_32_32_32_nkm(ab_ref, ab_ref, c)
    REQUIRE( c[0][0] == c_float_ref[0][0])
    REQUIRE( c[0][1] == c_float_ref[0][1])
