  .type gemm_asm_bf16_16_12_64, %function
        .global gemm_asm_bf16_16_12_64
        /*
         * Perform Matrix-Matrix-Multiplication C+= A*B using bfloat_16
         * Shapes are (16 X 12) = (16 X 64) * (64 X 12)
         * @param x0 pointer to A
         * @param x1 pointer to B
         * @param x2 pointer to C
         */ 
gemm_asm_bf16_16_12_64:
...
loop_k: 
       ...
       // store accumulator C 
        ...
        ret
        .size gemm_asm_bf16_16_12_64, (. - gemm_asm_bf16_16_12_64)