...
void ( *mini_jit::generators::SmallGemmSve::generate( uint32_t i_m,
  ...
  m_kernel.addInstruction(mini_jit::instructions::Base::dpSubImm(2, 2, 5*16*4 + 3*16, 0));
  ...
  m_kernel.addInstruction(mini_jit::instructions::Base::dpSubImm(1, 1, 6*48*4 - 4, 0));
  m_kernel.addInstruction(mini_jit::instructions::Base::dpAddImm(0, 0, 16*4, 0));
